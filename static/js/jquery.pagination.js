...
;( function( $, window, undefined ) {
	...
	$.Pagination.prototype = {
		...
		_initEvents : function() {
			...
			this.slider.getHandle().on( 'hover', function() {
			...
			this.slider.getSlider().on( {
				'slidestop' : function( event, ui ) {
					...
					self.$el.stop().applyStyle( { width : self.options.width }, $.extend( true, [], { duration : '150ms', complete : animcomplete } ) ).on( self.transEndEventName, function() {
